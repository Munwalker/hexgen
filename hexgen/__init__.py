...
def draw_grid(hex_grid):
    ...
    HexGridDraw(hex_grid, color_territories, "../output/map_territories.png", rivers=False, show_coasts=True,
                borders=True)
    ...
    HexGridDraw(hex_grid, color_zone, "../output/map_latitude.png", text_func=hex_latitude, rivers=False,
                show_coasts=False)
    HexGridDraw(hex_grid, color_pressure_end_year, "../output/map_pressure_end_year.png", rivers=False,
                show_coasts=True)
    HexGridDraw(hex_grid, color_pressure_mid_year, "../output/map_pressure_mid_year.png", rivers=False,
                show_coasts=True)
    HexGridDraw(hex_grid, color_wind_end_year, "../output/map_wind_end_year.png", text_func=wind_display_end_year,
